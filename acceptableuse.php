<?php
    ...
    */
	...
	$file = "acceptableuse.php";
	$description = "This is the Acceptable Use page of the Lab 4 assignment for WEBD3201";
	$date = "December 15, 2020";
	$banner = "Acceptable Use";
    include "./includes/header.php";
    // The Following Acceptable Use Policy was generated by https://www.websitepolicies.com/ 
?>
...
<h2 class="display-4">System abuse</h2>
...
<h2 class="display-4">Service resources</h2>
...
<h2 class="display-4">No spam policy</h2>
...
<h2 class="display-4">Copyrighted content</h2>
...
<h2 class="display-4">Security</h2>
...
<h2 class="display-4">Enforcement</h2>
...
<h2 class="display-4">Reporting violations</h2>
...
<h2 class="display-4">Changes and amendments</h2>
<p>We reserve the right to modify this Policy or its terms relating to the Website and Services at any time, effective upon posting of an updated version of this Policy on the Website. When we do, we will revise the updated date at the bottom of this page. Continued use of the Website and Services after any such changes shall constitute your consent to such changes. Policy was created with <a style="color:blue;" target="_blank" href="https://www.websitepolicies.com/blog/sample-acceptable-use-policy-template">WebsitePolicies</a>.</p>
    
<h2 class="display-4">Acceptance of this policy</h2>
<p>You acknowledge that you have read this Policy and agree to all its terms and conditions. By accessing and using the Website and Services you agree to be bound by this Policy. If you do not agree to abide by the terms of this Policy, you are not authorized to access or use the Website and Services.</p>

<h2 class="display-4">Contacting Us</h2>
<p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to it, you may send an email to <?php echo WEBSITE_EMAIL; ?></p>
</div>
